...
contract ColonyAuthority is CommonAuthority {
  ...
  constructor(address _colony) public CommonAuthority(_colony) {
    ...
    addRoleCapability(ARBITRATION_ROLE, "setExpenditurePayoutScalar(uint256,uint256,uint256,address,uint256)");
    addRoleCapability(ARBITRATION_ROLE, "setExpenditureClaimDelay(uint256,uint256,uint256,address,uint256)");
  }
